...
Everything here is about the migration itself — none of it says anything about
whether the GCP infrastructure is correct.
...
| 4 | The post's photo displays rather than showing a broken image | Uploads are present in the image and `wp_postmeta` attachment paths resolve |
